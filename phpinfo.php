...
<head>
	...
	<title>PHP程序(获取服务器信息)</title>
</head>
<body>
<?php
	// $sysos = $_SERVER["SERVER_SPFTWATE"];		//获取服务器标识的字符串
	// $sysversion = PHP_VERSION;					//获取PHP服务器版本
	//
	// //一下两条代码连接MySQL数据库并获取MySQL数据库版本信息
	// mysql_connect("localhost","root","67535782");
	...
	//
	// //以下两条代码用于获取服务器时间，中国大陆采用的是东八区的时间，设置时区写成Etc/GMT-8
